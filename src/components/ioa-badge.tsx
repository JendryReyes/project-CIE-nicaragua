...
export function IoaBadge({ pct }: { pct: number }) {
  const tone = pct >= 90 ? "bg-[oklch(0.94_0.044_160)] text-[oklch(0.4_0.088_160)]" : pct >= 80 ? "bg-[oklch(0.94_0.053_80)] text-[oklch(0.4_0.114_80)]" : "bg-[oklch(0.94_0.053_30)] text-[oklch(0.45_0.132_30)]";
  return (
