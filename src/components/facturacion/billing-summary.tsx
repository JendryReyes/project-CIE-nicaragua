...
const estadoTone: Record<string, string> = {
  Completada: "bg-[oklch(0.94_0.06_155)] text-[oklch(0.4_0.12_155)]",
  Facturada: "bg-[oklch(0.94_0.05_240)] text-[oklch(0.4_0.12_240)]",
  Programada: "bg-muted text-muted-foreground",
  Cancelada: "bg-[oklch(0.96_0.05_25)] text-[oklch(0.45_0.15_25)]",
  "No-show": "bg-[oklch(0.96_0.05_25)] text-[oklch(0.45_0.15_25)]",
  Borrador: "bg-muted text-muted-foreground",
  Enviado: "bg-[oklch(0.94_0.05_240)] text-[oklch(0.4_0.12_240)]",
  Aceptado: "bg-[oklch(0.94_0.06_155)] text-[oklch(0.4_0.12_155)]",
  Rechazado: "bg-[oklch(0.96_0.05_25)] text-[oklch(0.45_0.15_25)]",
  Pagada: "bg-[oklch(0.94_0.06_155)] text-[oklch(0.4_0.12_155)]",
  Pagado: "bg-[oklch(0.94_0.06_155)] text-[oklch(0.4_0.12_155)]",
  Vencida: "bg-[oklch(0.96_0.05_25)] text-[oklch(0.45_0.15_25)]",
  Anulada: "bg-muted text-muted-foreground line-through",
  Emitida: "bg-[oklch(0.94_0.05_85)] text-[oklch(0.4_0.12_85)]",
  Aplicado: "bg-[oklch(0.94_0.06_155)] text-[oklch(0.4_0.12_155)]",
  Parcial: "bg-[oklch(0.94_0.05_85)] text-[oklch(0.4_0.12_85)]",
...
function KPI({ label, value, accent, warn }: { label: string; value: string; accent?: boolean; warn?: boolean }) {
  return (
    <div className={`rounded-xl border p-3 ${warn ? "border-[oklch(0.85_0.12_25)] bg-[oklch(0.98_0.03_25)]" : "border-border/70 bg-background"}`}>
      <div className="text-[10px] uppercase tracking-wider text-muted-foreground">{label}</div>
      <div className={`font-display text-lg mt-0.5 tabular ${accent ? "text-primary" : ""} ${warn ? "text-[oklch(0.45_0.15_25)]" : ""}`}>{value}</div>
    </div>
  );
}
    ...
    <TableWrap headers={["Factura", "Fecha", "Cliente", "Visitas", "Monto", "Saldo", "Estado"]}>
      {rows.map((i) => (
        <tr key={i.id} className="hover:bg-muted/30">
          ...
          <td className={`px-3 py-2 tabular ${i.saldo > 0 ? "text-[oklch(0.45_0.15_25)] font-medium" : "text-muted-foreground"}`}>
