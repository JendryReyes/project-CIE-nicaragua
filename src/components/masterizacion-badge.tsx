...
export function MasterizacionBadge({ programa }: { programa: Programa }) {
  ...
  return (
    <div className={`inline-flex items-center gap-3 rounded-xl border px-3 py-2 text-xs ${ok ? "border-[oklch(0.62_0.11_155)]/40 bg-[oklch(0.94_0.05_155)]/40" : "border-border bg-muted/40"}`}>
      {ok ? (
