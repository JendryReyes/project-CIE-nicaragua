...
import { ArrowLeft, FileText, Download, CheckCircle2, AlertTriangle, XCircle, Search } from "lucide-react";
...
export const Route = createFileRoute("/_app/facturacion/cartas")({
  head: () => ({ meta: [{ title: "Cartas INSS · CIE" }] }),
  component: CartasINSS,
});
...
function CartasINSS() {
  ...
  const cartas = useMemo(() => {
    // tick fuerza recálculo después de renovar
    void tick;
  ...
  return (
    <div className="space-y-6 max-w-[1400px]">
      <div>
        ...
        <h1 className="font-display text-3xl">Cartas INSS</h1>
